...
<footer id="footer" className="relative py-12 mt-12 overflow-hidden text-white bg-gradient-to-r from-deep-blue to-purple-blue">      {/* Decorative background elements */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute w-32 h-32 bg-white rounded-full top-10 left-10 mix-blend-overlay"></div>
        <div className="absolute w-48 h-48 rounded-full bottom-10 right-10 bg-light-blue mix-blend-overlay"></div>
        <div className="absolute w-24 h-24 rounded-full top-1/2 left-1/3 bg-light-purple mix-blend-overlay"></div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-8 mb-8 md:grid-cols-3">
          ...
          <div className="footer-item">
            ...
            <ul className="space-y-3">
              <li>
                <a href="/" className="flex items-center transition-colors hover:text-light-purple">
              ...
              <li>
                <a href="/courses" className="flex items-center transition-colors hover:text-light-purple">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="/instructors" className="flex items-center transition-colors hover:text-light-purple">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="/contact" className="flex items-center transition-colors hover:text-light-purple">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
