    ...
    <section ref={sectionRef} className="py-16 bg-gradient-to-b from-deep-blue/10 to-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16" ref={titleRef}>
          <h1 className="text-4xl md:text-5xl font-bold text-deep-blue mb-4">Contact Us</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div ref={formRef} className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-gradient-to-r from-deep-blue to-purple-blue text-white font-bold py-3 px-8 rounded-lg hover:from-purple-blue hover:to-light-blue transition-all duration-300"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-deep-blue mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <div>
                    <h3 className="font-medium text-gray-800">Email</h3>
                    <p className="text-gray-600">batchpilot@.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-deep-blue mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
